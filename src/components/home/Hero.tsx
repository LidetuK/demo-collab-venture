        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className={`space-y-8 ${isVisible ? 'animate-fade-in-right' : 'opacity-0'}`}>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-brand-black">
              Creative Solutions That <span className="text-gradient">Inspire Action</span>
            </h1>
            <p className="text-lg md:text-xl text-gray-600 max-w-xl">
              We transform ideas into impactful advertising campaigns that connect brands with their audience across all media channels.
            </p>
          ...
          <div className={`relative ${isVisible ? 'animate-fade-in-left' : 'opacity-0'}`}>
            <div className="relative w-full h-[400px] md:h-[500px] rounded-2xl overflow-hidden shadow-xl">
              {/* Main image - this would be replaced with a real image */}
              <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/90 to-brand-blue/70 rounded-2xl flex items-center justify-center">
                <div className="text-white text-center p-8">
                  <div className="animate-float">
                    <svg className="w-24 h-24 mx-auto mb-6 text-white/90" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <h3 className="text-3xl font-bold mb-4">Captivating Campaigns</h3>
                  <p className="text-white/80">
                    Our award-winning creative team develops advertising solutions that leave lasting impressions and drive real results.
                  </p>
                </div>
              </div>
